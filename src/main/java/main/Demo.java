...
public class Demo {
    ...
    public List<List<GeoPosition>> runSearches(MapNode startNode, MapNode endNode, List<Planner> planners) {
        ...
        for (Planner planner : planners) {
            ...
            System.out.printf("Time taken: %d ms %n", end_time - start_time);
            printResult(result);
...
//        String osmFile = "./data/toronto_small.osm";
//        String osmFile = "./data/queens_park.osm";
        ...
        Planner greedyPlanner = new GreedyBestFirstPlanner(heuristic);
